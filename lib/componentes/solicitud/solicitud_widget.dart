...
class SolicitudWidget extends StatefulWidget {
  const SolicitudWidget({
    super.key,
    required this.solicitud,
  });

  final SolicitudesRecord? solicitud;
        ...
        child: Column(
          ...
          children: [
            StreamBuilder<UsersRecord>(
              stream: UsersRecord.getDocument(widget.solicitud!.usuario!),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  StreamBuilder<ExperienciaRecord>(
                    stream: ExperienciaRecord.getDocument(
                        widget.solicitud!.posicion!),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                      ...
                      final textExperienciaRecord = snapshot.data!;

                      return Text(
                        textExperienciaRecord.title,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.inter(
                                fontWeight: FlutterFlowTheme.of(context)
                                    .bodyMedium
