...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF43473B);
  late Color secondary = const Color(0xFFF6ECD9);
  late Color tertiary = const Color(0xFF66784A);
  late Color alternate = const Color(0xFF66534C);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFD2C69C);
  late Color accent2 = const Color(0xFFA8A489);
