...
/// send a maito con las especificacioes del viaje, destino fechas y
/// actvidades
class HomePageStudentWidget extends StatefulWidget {
  const HomePageStudentWidget({super.key});

  static String routeName = 'HomePageStudent';
  static String routePath = '/homePageStudent';

  @override
  State<HomePageStudentWidget> createState() => _HomePageStudentWidgetState();
}
...
class _HomePageStudentWidgetState extends State<HomePageStudentWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageStudentModel());
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.experienciaCardModels
                                              .getModel(
                                            listViewExperienciaRecord
                                                .reference.id,
                                            listViewIndex,
                                          ...
                                          child: ExperienciaCardWidget(
                                            key: Key(
                                              'Keyao2_${listViewExperienciaRecord.reference.id}',
                                            ),
