...
class ExploreCopyWidget extends StatefulWidget {
  const ExploreCopyWidget({super.key});

  static String routeName = 'ExploreCopy';
  static String routePath = '/exploreCopy';

  @override
  State<ExploreCopyWidget> createState() => _ExploreCopyWidgetState();
}

class _ExploreCopyWidgetState extends State<ExploreCopyWidget> {
  late ExploreCopyModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UbicacionesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UbicacionesRecord> exploreCopyUbicacionesRecordList =
            snapshot.data!;
